...
/// A type-erased container that uses a description of the value's reflected hierarchy for equatability, or a UUID if the container is initialized as unique.
///
@available ( iOS 16.0, * )
